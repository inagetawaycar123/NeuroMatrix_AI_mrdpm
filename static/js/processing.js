...
const UPLOAD_NODES = [
    ...
    { key: "vessel_classification", title: "Vessel_Classification.classify()", subtitle: "血管堵塞三分类分析", chip: "Vessel_Class", delegated: "classify_vessel_occlusion" },
...
const TOOL_META = Object.freeze({
    ...
    classify_vessel_occlusion: ["Vessel_Classification.classify()", "血管堵塞三分类", "Vessel_Class"],
...
const TEMPLATES = Object.freeze({
    ...
    vessel_classification: ["系统正在分析血管堵塞情况。", "识别大血管闭塞、小血管病变与无明显狭窄。", "为血管介入决策提供依据。"],
